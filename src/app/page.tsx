    ...
    "@graph": [
      {
        ...
        offers: { "@type": "Offer", price: "79", priceCurrency: "EUR", description: "79 € par mois, sans engagement, essai 14 jours" },
        ...
        <div className="container">
          <Reveal>
            <div style={{ textAlign: "center" }}>
              <span className="kicker">Tarif</span>
              <h2>Un chantier récupéré rembourse l&apos;année</h2>
            </div>
          </Reveal>
          <Reveal delay={120}>
            <div className="pricing-card" style={{ marginTop: 32 }}>
              <div className="price">
                79 €<small> / mois</small>
              </div>
              <ul>
                <li>Appels manqués illimités, 24/7</li>
                <li>Numéro dédié + renvoi d&apos;appel inclus</li>
                <li>Fiches qualifiées par SMS + tableau de bord</li>
                <li>Sans engagement — résiliable en un message</li>
                <li>Essai 14 jours, sans carte bancaire</li>
                <li>Installation accompagnée au téléphone</li>
              </ul>
              <a className="btn btn-primary" href={CTA_HREF}>
